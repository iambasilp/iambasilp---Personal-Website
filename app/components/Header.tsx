      ...
      <nav className="flex space-x-4 md:space-x-6 text-sm font-medium text-gray-600 dark:text-zinc-400">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            ...
            {/* Socials Section */}
            <div className="px-3 pb-1 pt-3 mt-1 text-[10px] font-sans uppercase tracking-[0.2em] text-gray-400 dark:text-zinc-500 border-t border-gray-100 dark:border-zinc-800/50">
              Socials
            </div>
            <a 
