      ...
      <nav className="flex space-x-4 md:space-x-6 text-sm font-medium text-gray-600 dark:text-zinc-400">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            ...
            >
              Socials
              <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className={`h-3 w-3 transition-transform duration-300 ${isSocialsOpen ? 'rotate-180' : ''}`} xmlns="http://www.w3.org/2000/svg"><path d="M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z"></path></svg>
            </button>
